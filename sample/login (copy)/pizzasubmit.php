...
$sql = "INSERT INTO Members (name,ID,Time_length,Task,Assigned_by,Expected_completion,Date,Comment)
VALUES ('".$_POST["name"]."','".$_POST["ID"]."','".$_POST["Time_length"]."'
,'".$_POST["Task"]."','".$_POST["Assigned_by"]."','".$_POST["Expected_Completion"]."'
,'".$datedate."','".$_POST["Comment"]."')";
